...
/**
 * Servlet implementation class UsersRegisterConfirm
 */
@WebServlet("/UsersRegisterConfirm")
@MultipartConfig(location="", maxFileSize=1024 * 1024 * 2)
public class UsersRegisterConfirm extends HttpServlet {
	private static final long serialVersionUID = 1L;


    public UsersRegisterConfirm() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//確認画面にフォワード
		request.getRequestDispatcher("/WEB-INF/jsp/usersRegisterConfirm.jsp").forward(request, response);
			...
			response.sendRedirect("/MyWebSite/UsersRegister");
		}
	}
